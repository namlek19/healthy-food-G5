...
<head>
    ...
    <style>
        .order-detail-title { color: #25bb55; text-align: center; margin-bottom: 20px; }
        .order-detail-box { background: #fff; border-radius: 8px; padding: 24px 28px; max-width: 800px; margin: 32px auto 0 auto; box-shadow: 0 4px 24px #eef5f0; }
        .order-info-row { margin-bottom: 9px; }
        .order-info-label { font-weight: bold; color: #16793a; }
        .order-status { font-weight: bold; color: #25bb55; }
        .order-table { width: 100%; border-collapse: collapse; margin-top: 18px; background: #f9fff7; }
        .order-table th, .order-table td { padding: 9px; border-bottom: 1px solid #e6f6e9; text-align: center; }
        .order-table th { background: #25bb55; color: #fff; }
        .product-thumb-info { width: 58px; border-radius: 6px; object-fit: cover; }
        .back-history { margin-top: 24px; display: block; text-align: left; color: #25bb55; font-weight: bold; text-decoration: none; }
        .back-history:hover { color: #16793a; }
    </style>
</head>
