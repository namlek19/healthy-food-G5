    ...
    <div class="container">
        <div class="row text-white footer-row">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-center align-items-start text-start contact-info">
                ...
                <p><i class="bi bi-telephone-fill"></i> 0902.099.905</p>
            ...
            <div class="col-md-4 d-flex flex-column justify-content-center align-items-center align-items-md-end social-icons text-center text-md-end">
                ...
                <div>
                    <a href="https://www.facebook.com/nam.le.854654"><i class="bi bi-facebook"></i></a>
                    <a href="https://www.instagram.com/namle.nadule/"><i class="bi bi-instagram"></i></a>
                    <a href="https://youtube.com/@namle3585?si=Va6Dy1lqjTy2S5Dm"><i class="bi bi-youtube"></i></a>
                    <a href="https://www.threads.com/@namle.nadule"><i class="bi bi-threads"></i></a>
                </div>
            </div>
        </div>
